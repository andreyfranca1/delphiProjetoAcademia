...
type
  ...
  public
    { Public declarations }
    property DataModuleCadastro: TdtmCadastro read FDataModuleCadastro
      write FDataModuleCadastro;
    property FormFiltroCadastro: TformFiltroCadastro read FFormFiltroCadastro
      write FFormFiltroCadastro;
    property FormManutCadastro: tformManutCadastro read FFormManutCadastro
      write FFormManutCadastro;
  end;
...
begin
  if not(FDataModuleCadastro = nil) then
    ...
    begin
      ...
      btnPrimeiro.Enabled := not onEdicao and not tabelaVazia and
        not inicioDados;
      btnAnterior.Enabled := not onEdicao and not tabelaVazia and
        not inicioDados;
