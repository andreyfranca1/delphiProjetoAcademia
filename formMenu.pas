...
type
 TfrmMenu = class(TForm)
    ...
    procedure MatriculaRelatorioClick(Sender: TObject);
    procedure ServicoRelatorioClick(Sender: TObject);
...
uses dmCadastro, frmCadastro, dmConexao, frmClientes, dmClientes, dmPlanos,
  ...
  frmRelatorioMatricula, frmFiltroRelatorioMatricula;
...
procedure TfrmMenu.MatriculaRelatorioClick(Sender: TObject);
begin
  formFiltroRelatorioMatricula := TformFiltroRelatorioMatricula.Create(self);
  try
    formFiltroRelatorioMatricula.ShowModal;
  finally
    FreeAndNil(formFiltroRelatorioMatricula);
  end;
end;
...
procedure TfrmMenu.ServicoRelatorioClick(Sender: TObject);
begin
  formFiltroRelatorioServico := TformFiltroRelatorioServico.Create(self);
  try
    formFiltroRelatorioServico.ShowModal;
  finally
    FreeAndNil(formFiltroRelatorioServico);
  end;
end;
